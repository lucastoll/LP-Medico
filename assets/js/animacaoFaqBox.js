...
/* Scroll reveal FaqBox */

/* Animação faqBox */
const animaFaqBox = function revealCaseBox () {
     let cases = document.getElementsByClassName('faq__boxwrapper')
     ...
     {
          var elementTop = cases[1].getBoundingClientRect().top;
          ...
          {                                         
               ...
               {
                    cases[i].classList.remove("faq__boxwrapper--invisivel")
               }
          } 
     }
 ...
 window.addEventListener("scroll", animaFaqBox);